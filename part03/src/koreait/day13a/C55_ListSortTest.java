...
public class C55_ListSortTest {
	...
	public static void main(String[] args) {
		...
		ilist.sort(Comparator.reverseOrder()); // reverse : 역순(내림차순), Comparator인터페이스의 static 메서드
...
//		mlist.sort(null); // 오류 : Member 객체는 비교할 수 없는 객체 -> 비교자 인터페이스를 인자로 해야함.
		...
		ulist.add(new User("나나",23));
		ulist.add(new User("나연",23));
		ulist.add(new User("다현",23));
		ulist.add(new User("수니",23));
