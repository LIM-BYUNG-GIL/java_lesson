...
public class BinaryTest2 {
	public static void main(String[] args) {
		...
		System.out.println("16진수 0xa41c 리터럴" + n16); // 정수값 출력은 format 지정 안하면 10진수
		System.out.println("2진수 0b1010010000011100 리터럴" + n2);
		
		System.out.println("2. format 지정하여 16진수 출력");
		System.out.println(String.format("16진수 0xa41c 리터럴 : %x", n16)); // 16진수 형식 %x
		System.out.println(String.format("2진수 0b1010010000011100 리터럴 : %x", n2));
		System.out.println(String.format("10진수 42012 리터럴 : %x", 42012));
		...
		// 원래는 Integer.parseInt(s) 이 형식이었고 s 문자열이 10진수 표현이라는 의미입니다.
...
/* <<요약>>
 * n은 2(Binary), 8(octal), 16(hes) 가능합니다.
 * n진법 문자열 -> 10진 정수값 변환 Integer.parseInt(문자열, n)
 * 10진 정수값 -> n진법 문자열 Integer.toBinaryString 메서드, toHexString 메서드
 * 
 * format 에서 %d는 10진수, %x는 16진수, %o는 8진수 참고로 2진수는 포맷형식 없습니다.
 * 
