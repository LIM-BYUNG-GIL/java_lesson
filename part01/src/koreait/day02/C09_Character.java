...
//		System.out.printf("c1 = %d\n", c1); // ¿À·ù : charÇüÀº %d°¡ ¾Æ´Õ´Ï´Ù.
		...
		c1++; // ++¿¬»êÀº c1 = c1 + 1; charÇü¿¡¼­´Â castingÀÌ ÇÊ¿ä¾ø½À´Ï´Ù.
		System.out.println("c1 = " + c1);
		...
		// ÇÑ±ÛÀÇ ¸¶Áö¸· ¹®ÀÚ
		char h4 = 55203; // 10Áø¼ö·Î Ç¥Çö
		char h5 = '\ud7a3'; // 16Áø¼ö·Î Ç¥Çö, ÆR
 ...
 *  ÄÄÇ»ÅÍ¿¡¼­ ´Ù·ç´Â ¹®ÀÚ´Â ¹®ÀÚÄÚµå·Î Ã³¸®µÇ´Âµ¥ ÄÚµå´Â Á¤°ªÀÔ´Ï´Ù.
 *  ¹®ÀÚµ¥ÀÌÅÍ´Â '' ±âÈ£¸¦ »ç¿ëÇÕ´Ï´Ù.
 *  
 *  ¿µ¹®ÀÚ, ¼ýÀÚ, Æ¯¼ö¹®ÀÚ´Â ASCII ÄÚµå·Î Ç¥ÇöµË´Ï´Ù.
 *  ¿µ¹®ÀÚ, ¼ýÀÚ, Æ¯¼ö¹®ÀÚ ¿ÜÀÇ ´Ù±¹¾î ¹®ÀÚ´Â ¹®ÀÚ¸¦ Ã³¸®ÇÏ´Â ÀÎÄÚµù¹æ½Ä¿¡ µû¶ó ¹®ÀÚÄÚµå°ªÀÌ ´Ù¸¨´Ï´Ù.
 *  ±¹Á¦È­ ÀÎÄÚµùÀ¸·Î utf-8 ¹æ½ÄÀ» ¸¹ÀÌ »ç¿ëÇÕ´Ï´Ù. 
 *   
 *   
 *  °£ : ¤¡ ¤¿ ¤¤ (ÃÊ¼º, Áß¼º, Á¾¼º °¢°¢¿¡ ÄÚµå°ªÀ¸·Î Á¶ÇÕÇÏ´Â Á¶ÇÕÇü)
 *  ÇÑ±Û¿¡¼­ ³ª¿Ã ¼ö ÀÕ´Â ¸ðµç ÃÊ¼º/Áß¼º/Á¾¼ºÀÇ ¸ðµç Ç¥ÇöÀ» ¸¸µé¾î¼­ °¢°¢ ÄÚµå°ªÀ» ºÎ¿©ÇÏ´Â ¿Ï¼ºÇü
 *  
 */