...
//		my.age = 23; // 오류 : private 한정자 필드
		my.setAge(23); // private 필드값 대입(변경)하는 메서드 : setter
//		System.out.println("age = " + my.age); // 오류 : private 한정자 필드
		System.out.println("age = " + my.getAge()); // private 필드값 읽어오는 메서드 : getter
		my.setAge(-100);
		System.out.println("age = " + my.getAge()); // private 필드값 읽어오는 메서드 : getter
	...
	// 접근 한정자 테스트는 자바에서 제공되는 클래스들을 이해하고 우리가 만들 클래스에서도 사용
}
