...
public class DateTimeTest {
	public static void main(String[] args) {
		...
		// int 범위 벗어나면 overflow 입니다. long변환 필요
		...
		// now() 메서드로 현재 시간 날짜 객체 생성
		LocalDate currentDate = LocalDate.now(); // static 메서드로 객체를 생성
		...
		// 새 버전 클래스는 날짜 사이의 간격 계산 클래스가 있습니다. (내가 태어난지 몇년? 몇달? 며칠?)
		...
		System.out.println("내가 태어난지 " + between.getDays() + " 일(date)");
